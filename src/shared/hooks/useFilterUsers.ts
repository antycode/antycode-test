...
export const useFilterUsers = <T>({allRecords, currentPage, perPageCount}: {
    allRecords: T[],
    currentPage: number,
    perPageCount: number
}) => {
...
//                 const allFilteredRecords = filterRecordsBySearchText(searchField, searchText)
//                 setFilteredRecords(allFilteredRecords)
//                 const itemsForPage = getItemsForCurrentPage(allFilteredRecords)
//                 setCurrentPageRecords(itemsForPage)
//             } else {
//                 setFilteredRecords(allRecords)
//                 const itemsForPage = getItemsForCurrentPage(allRecords)
...
//         setCurrentPageRecords, filteredRecords, useSort, setUseSort
//     };
// };
