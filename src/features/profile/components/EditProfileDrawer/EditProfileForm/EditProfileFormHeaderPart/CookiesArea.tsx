...
import cls from './CookiesArea.module.scss';
...
export const CookiesArea = React.forwardRef((field: any, ref: any) => {
    ...
    return importFileSuccess ? (
        ...
        <div className={cls.fieldCookie} onClick={handleClickInsideFieldCookie} id="drop_zone" onDrop={onDropHandler} onDragOver={onDragOver}>
