...
import {TProfileCreationForm} from "@/features/profile/components/ProfileCreationDrawer/ProfileCreationForm/ProfileCreationForm";
...
interface ProfileMassImportFormFooterPartProps {
    media: MediaType,
...
export const ProfileMassImportFormFooterPart = (props: ProfileMassImportFormFooterPartProps) => {
    const {
        media,
        setMedia,
        setRamOption,
