...
import cls from './ProfileReview.module.scss';
...
import { ReactComponent as FingerprintIcon } from '@/shared/assets/icons/finger-print.svg';
...
const ProfileReview = (props: ProfileReviewProps) => {
  const { profileDataReview, platformLabel, setProfileDataReview } = props;

  const { t } = useTranslation();

  const { options} = useProfileInitData();

  const { setUserAgent } = useWorkspacesStore();
  
  const handleClickPrint = (e: any) => {
    e.preventDefault();
  ...
  return (
    <div className={cls.review}>
      <div className={cls.title}>
        <p>{t('Review')}</p>
        <Button className={cls.btn} onClick={handleClickPrint}>
      ...
      <div className={cls.reviewItem}>
        ...
        <div className={cls.reviewItemOsWrapper}>
          {platformLabel === 'Windows' && <WindowsIcon />}
          {platformLabel === 'Linux' && <LinuxIcon />}
          {platformLabel === 'Macos' && <MacosIcon />}
          <p
            className={clsx(
              cls.reviewItemData,
              cls.reviewItemDataOs,
              platform === 'Windows' ? cls.reviewItemDataOsWin : '',
            )}>
            {platformLabel}
          </p>
        </div>
      ...
      <div className={cls.reviewItem}>
        ...
        <p className={cls.reviewItemData}>{t(profileDataReview.profileProxyType).toUpperCase()}</p>
      </div>
      <div className={cls.reviewItem}>
        <p className={cls.reviewItemTitle}>{t('WebRTC')}:</p>
        <p className={cls.reviewItemData}>{t(profileDataReview.profileWebRtc)}</p>
      </div>
      <div className={cls.reviewItem}>
        <p className={cls.reviewItemTitle}>{t('Canvas')}:</p>
        <p className={cls.reviewItemData}>{t(profileDataReview.profileCanvas)}</p>
      </div>
      <div className={cls.reviewItem}>
        <p className={cls.reviewItemTitle}>{t('WebGL')}:</p>
        <p className={cls.reviewItemData}>{t(profileDataReview.profileWebGL)}</p>
      </div>
      <div className={cls.reviewItem}>
      ...
      <div className={cls.reviewItem}>
        ...
        <p className={cls.reviewItemData}>{t(profileDataReview.profileClientsRects)}</p>
      </div>
      <div className={cls.reviewItem}>
        ...
        <p className={clsx(cls.reviewItemData, cls.reviewItemDataTimezone)}>
          {profileDataReview.profileTimezone === 'Auto' ? (
            ...
            <>
              ...
              <p>{t(profileDataReview.profileTimezone.zone)}</p>
            </>
          )}
        </p>
      </div>
      <div className={cls.reviewItem}>
        ...
        <p className={cls.reviewItemData}>{t(profileDataReview.profileLanguage)}</p>
      </div>
      <div className={cls.reviewItem}>
      ...
      <div className={cls.reviewItem}>
        ...
        <p className={cls.reviewItemData}>
          {profileDataReview.profileProcessor == '2' ||
          profileDataReview.profileProcessor == '4' ? (
            <>
              {t(profileDataReview.profileProcessor)} {t('cores-2-4.Cores')}
            </>
          ) : (
            false
          )}
          {profileDataReview.profileProcessor == '6' ||
          profileDataReview.profileProcessor == '8' ||
          profileDataReview.profileProcessor == '12' ||
          profileDataReview.profileProcessor == '16' ? (
            <>
              {t(profileDataReview.profileProcessor)} {t('cores-another.Cores')}
            </>
          ) : (
            false
          )}
          {profileDataReview.profileProcessor === 'Real' ||
          profileDataReview.profileProcessor === 'Random' ? (
            <>{t(profileDataReview.profileProcessor)}</>
          ) : (
            false
          )}
        </p>
      ...
      <div className={cls.reviewItem}>
        ...
        <p className={cls.reviewItemData}>{t(profileDataReview.profileScreen)}</p>
      </div>
      <div className={cls.reviewItem}>
        <p className={cls.reviewItemTitle}>{t('Audio')}:</p>
        <p className={cls.reviewItemData}>{t(profileDataReview.profileAudio)}</p>
      </div>
      <div className={cls.reviewItem}>
        <p className={cls.reviewItemTitle}>{t('Media')}:</p>
        <p className={cls.reviewItemData}>
          {profileDataReview.profileMedia === 'Real' ||
          profileDataReview.profileMedia === 'Random' ? (
            t(profileDataReview.profileMedia)
          ) : (
            <>
              {profileDataReview.profileMedia.microphone}/{profileDataReview.profileMedia.speaker}/
              {profileDataReview.profileMedia.camera}{' '}
            </>
          )}
        </p>
      </div>
      <div className={cls.reviewItem}>
        ...
        <p className={cls.reviewItemData}>{t(profileDataReview.profilePorts)}</p>
      </div>
      <div className={cls.reviewItem}>
        <p className={cls.reviewItemTitle}>{t('Do not track')}:</p>
        <p className={cls.reviewItemData}>{t(profileDataReview.profileIsDoNotTrack)}.</p>
      </div>
    </div>
  );
};
